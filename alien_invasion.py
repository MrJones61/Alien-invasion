...
class AlienInvasion:
    ...
    def _update_screen(self):
        ...
        # Draw the play button if the gmae is inactive
    ...
    def _update_aliens(self):
        """ Check if fleet is at an edge,
                then update the postions of all the aliens in the fleet."""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Decreament ships left
            self.stats.ships_left -= 1

            # Get rid of nay remaining aliens
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _check_aliens_bottom(self):
        """ Check is any alien has reached the bottom of the screen."""
